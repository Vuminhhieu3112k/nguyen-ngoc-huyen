<template>
  <div class="">
      <div class="text-center m-auto w-3/4 text-6xl text-blue-600 mb-8">Tình yêu của anh sẽ lớn dần, theo số phút mà chúng ta yêu nhau</div>
      <div class="flex justify-center text-6xl text-blue-600 mb-8">{{love}} phút</div>
